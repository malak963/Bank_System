<x-guest-layout>
    <div class="mb-8">
        ...
        <h1 class="mt-3 text-3xl font-semibold tracking-tight text-slate-950">{{ __('Create Customer Account') }}</h1>
        <p class="mt-2 text-sm leading-6 text-slate-500">{{ __('Register to open and access your digital banking account.') }}</p>
    </div>
