<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h2 class="mt-1 text-2xl font-semibold leading-tight text-slate-950">{{ __('Two-Factor Authentication') }}</h2>
        </div>
    </x-slot>
                        ...
                        <div class="flex items-start gap-4 p-4 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-amber-800 mt-1 leading-5">
                                    {{ __('Add extra security to your banking account. When 2FA is active, signing in will require a one-time passcode from your mobile authenticator app.') }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-900 mb-8">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-emerald-800 mt-1 leading-5">
                                    {{ __('Your account is secured with two-factor authentication.') }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <p class="text-xs text-slate-500 mb-4">
                                    {{ __('Scan this QR code with Google Authenticator or your favorite TOTP app.') }}
                                </p>
