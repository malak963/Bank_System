                    ...
                    <div>
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400">{{ config('bank.tagline') }}</p>
                            </div>
                        </div>
                        <p class="mt-16 text-xs font-semibold uppercase tracking-[0.22em] text-emerald-300">{{ config('bank.dashboard.eyebrow') }}</p>
                        <h1 class="mt-4 max-w-sm text-4xl font-semibold leading-tight tracking-tight text-white">{{ config('bank.dashboard.title') }}</h1>
                        <p class="mt-5 max-w-sm text-sm leading-7 text-slate-300">{{ config('bank.dashboard.description') }}</p>
                    </div>
                    ...
                    <div class="mb-8 lg:hidden">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500">{{ config('bank.tagline') }}</p>
                            </div>
                        </div>
                    </div>
                {{ $slot }}
